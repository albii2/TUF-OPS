...
## 1. TAE Onboarding Checklist (Sales Reps)

### Phase 1: Philosophy & Systems Welcome
- [ ] Read and understand the TUF Welcome Letter and Mission.
- [ ] Log in successfully to TUF Ops using your assigned 5XXX PIN.
...
## 2. Director Onboarding Checklist (Leadership)

### Phase 1: Leadership Alignment
- [ ] Review the State Director Briefing.
- [ ] Set up your 7XXX leadership PIN in the TUF Ops system.
- [ ] Confirm your assigned team members are mapped correctly in your dashboard.

### Phase 2: Territory Management
- [ ] Review zone allocation, territory coverage metrics, and school listings for your state.
- [ ] Understand how to resolve stuck (stale) opportunities and untouched prospects.

### Phase 3: Operational Oversight
- [ ] Learn how to approve/reject uniform orders and vendor routings.
- [ ] Practice overriding/assisting rep opportunities and verifying order handoff packets.
