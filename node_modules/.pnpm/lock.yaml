...
importers:
  ...
  apps/api:
    ...
    devDependencies:
      ...
      ts-node-dev:
        specifier: ^2.0.0
        version: 2.0.0(@types/node@25.6.0)(typescript@5.8.3)
      tsconfig-paths:
        specifier: ^4.2.0
        version: 4.2.0
...
snapshots:
  ...
  '@jest/core@30.3.0(ts-node@10.9.2(@types/node@25.6.0)(typescript@5.9.3))':
    dependencies:
      ...
      graceful-fs: 4.2.11
      jest-changed-files: 30.3.0
      jest-config: 30.3.0(@types/node@22.19.17)(ts-node@10.9.2(@types/node@25.6.0)(typescript@5.9.3))
      jest-haste-map: 30.3.0
      jest-message-util: 30.3.0
      jest-regex-util: 30.0.1
      jest-resolve: 30.3.0
  ...
  ts-node-dev@2.0.0(@types/node@25.6.0)(typescript@5.8.3):
    dependencies:
      chokidar: 3.6.0
      dynamic-dedupe: 0.3.0
      minimist: 1.2.8
      ...
      source-map-support: 0.5.13
      tree-kill: 1.2.2
      ts-node: 10.9.2(@types/node@25.6.0)(typescript@5.8.3)
      tsconfig: 7.0.0
      typescript: 5.8.3
    transitivePeerDependencies:
      - '@swc/core'
