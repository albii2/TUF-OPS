...
const seedRows: StoredManagedUser[] = [
  ...
  {
    id: 'u-director-william-denzer',
    firstName: 'William',
    lastName: 'Denzer',
    displayName: 'William Denzer',
    email: 'wdenzer79@yahoo.com',
    role: 'DIRECTOR',
    rank: 'Director',
    region: 'Midwest',
    state_market: 'MN',
  ...
  {
    id: 'u-rep-ryan-streetar',
    firstName: 'Ryan',
    lastName: 'Streetar',
    displayName: 'Ryan Streetar',
    email: 'ryan.streetar@tufsports.us',
    role: 'REP',
    rank: 'TAE',
    tier: 'TAE',
    region: 'Midwest',
    ...
    division: 'General',
    territory: 'Minnesota',
    subterritory: 'Minneapolis Metro',
    sport_focus: 'All',
    ...
    isCertified: false,
    credentialSalt: 'seed-ryan',
    credentialHash: '9da076a147ae858e418d04dda7837d5ddede4e7a19173d8089b31de491ca2dbf',
  },
  {
    id: 'u-rep-narena-anderson',
    firstName: 'Narena',
    lastName: 'Anderson',
    displayName: 'Narena Anderson',
    email: 'narena.anderson@tufsports.us',
    role: 'REP',
    rank: 'TAE',
    tier: 'TAE',
    region: 'Midwest',
    ...
    subterritory: 'TBD',
    sport_focus: 'All',
    assignedDirectorId: 'u-director-william-denzer',
    status: 'ACTIVE',
    ...
    directorSignedOff: false,
    isCertified: false,
    credentialSalt: 'seed-narena',
    credentialHash: '4f1ba5f8f8064c9ff228ddb0ad9d183ecea8162868f1dde2279343b9785b0d93',
  },
  {
