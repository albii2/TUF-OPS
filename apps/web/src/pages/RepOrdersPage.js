...
export function RepOrdersPage() {
    ...
    return (<div className="space-y-3 min-w-0">
      <Card title="My Orders" className="min-w-0">
        ...
        {myOrders.length === 0 ? (<EmptyState title="No orders yet" description="Orders will appear here once deals are Closed Won and handed off to production."/>) : (<div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-800/60">
                ...
                return (<tr key={order.id} className="hover:bg-slate-900/30 transition-colors cursor-pointer" onClick={() => navigate(`/orders/${order.id}`)}>
...
//# sourceMappingURL=RepOrdersPage.js.map