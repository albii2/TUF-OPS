...
import { consumeQueuedFeedback, FEEDBACK_EVENT, type FeedbackMessage } from '../services/feedbackService';
...
export function ToastHost() {
  const [feedback, setFeedback] = useState<FeedbackMessage | null>(() => consumeQueuedFeedback());
