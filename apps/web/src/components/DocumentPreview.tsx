...
import { type DocumentData, generateDocument } from '../lib/documentGenerator';
...
export function downloadDocument(data: DocumentData) {
...
export function printDocument(data: DocumentData) {
  const html = generateDocument(data);
