...
function getRepCommission(repName) {
...
export function RepEarnings({ repName }) {
    ...
    return (<div className="space-y-3">
      ...
      <Card title="Recent Commissions">
        <div className="space-y-2">
          {recentDeals.map((deal) => (<div key={deal.id} className="flex justify-between items-center">
...
//# sourceMappingURL=RepEarnings.js.map