...
export const roleConfig: Record<Role, RoleConfig> = {
  OWNER: {
    ...
    visiblePages: ['/dashboard', '/organizations', '/opportunities', '/orders', '/reports', '/settings', '/ops-workspace', '/territory'],
  },
  DIRECTOR: {
    ...
    visiblePages: ['/dashboard', '/organizations', '/opportunities', '/reports', '/settings', '/territory'],
  },
  REP: {
    ...
    visiblePages: ['/dashboard', '/organizations', '/opportunities', '/orders', '/settings', '/territory'],
  },
  OPS: {
    ...
    visiblePages: ['/dashboard', '/organizations', '/orders', '/ops-workspace', '/settings', '/reports', '/territory'],
  },
};
