...
export const roleConfig: Record<Role, RoleConfig> = {
  OWNER: {
    sidebarItems: ['dashboard', 'organizations', 'pipeline', 'invoices', 'ops_workspace', 'performance', 'territory', 'messages', 'programs', 'users', 'training', 'settings'],
  ...
  REP: {
    ...
    visiblePages: ['/dashboard', '/organizations', '/opportunities', '/orders', '/settings', '/my-opportunities', '/earnings', '/training'],
  },
  OPS: {
    sidebarItems: ['dashboard', 'ops_workspace', 'invoices', 'programs', 'training', 'settings'],
    ...
    visiblePages: ['/dashboard', '/organizations', '/orders', '/ops-workspace', '/settings', '/reports', '/training'],
  },
};
