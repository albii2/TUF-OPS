...
export const roleConfig: Record<Role, RoleConfig> = {
  ADMIN: {
    ...
    visiblePages: ['/command', '/organizations', '/opportunities', '/my-opportunities', '/team-opportunities', '/orders', '/academy/v2', '/people', '/recruiting', '/intake', '/comms', '/settings', '/territory', '/users', '/admin/certification', '/daily-command', '/forge', '/issues'],
  },
  REGIONAL_DIRECTOR: {
    ...
    visiblePages: ['/command', '/organizations', '/opportunities', '/team-opportunities', '/orders', '/academy/v2', '/people', '/recruiting', '/territory', '/admin/certification', '/issues'],
  },
  DIRECTOR: {
    sidebarItems: ['command', 'organizations', 'pipeline', 'orders', 'territory', 'academy', 'people', 'recruiting', 'issues'],
    dashboardWidgets: ["Today's Priorities", 'Team Status', 'Territory Snapshot'],
  ...
  REP: {
    ...
    visiblePages: ['/command', '/organizations', '/my-opportunities', '/opportunities/new', '/organizations/new', '/orders', '/academy/v2', '/settings', '/territory'],
  },
  OPERATIONS: {
