...
function documentShell(title, bodyContent) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
function generatePerformanceAgreement(data) {
    const body = `
...
function generateCommissionForm(data) {
    const body = `
...
function generateTerritoryLetter(data) {
    const body = `
