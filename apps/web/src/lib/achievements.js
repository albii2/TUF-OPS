...
export const ALL_QUALIFICATIONS = [
    // ═══ ACADEMY (Shield, Blue #2563EB) ════════════════════════════════════
    {
        ...
        check: (s) => {
            if (s.quizModulesPassed >= 5)
                return { tier: 'gold', value: s.quizModulesPassed };
            if (s.quizModulesPassed >= 3)
                return { tier: 'silver', value: s.quizModulesPassed };
            if (s.quizModulesPassed >= 1)
                return { tier: 'bronze', value: s.quizModulesPassed };
            return null;
        },
    },
    {
    ...
    },
    {
        ...
        check: (s) => {
            if (s.isLevel1Certified)
                return { tier: 'gold', value: 3 };
            if (s.quizModulesPassed >= 5)
                return { tier: 'silver', value: 2 };
            if (s.quizModulesPassed >= 1)
    ...
    },
    {
        ...
        check: (s) => {
            if (s.isLevel2Certified)
                return { tier: 'black', value: 4 };
            if (s.isLevel1Certified)
                return { tier: 'gold', value: 3 };
            return null;
        },
    ...
    // ═══ ACTIVITY (Chevron, White/Silver #94A3B8) ══════════════════════════
    {
        ...
        check: (s) => {
            if (s.prospectingActivities >= 1)
                return { tier: 'bronze', value: s.prospectingActivities };
            return null;
        },
    },
    {
    ...
    },
    {
        ...
        check: (s) => {
            if (s.prospectingActivities >= 100)
                return { tier: 'silver', value: s.prospectingActivities };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.prospectingActivities >= 500)
                return { tier: 'gold', value: s.prospectingActivities };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.prospectingActivities >= 1000)
                return { tier: 'black', value: s.prospectingActivities };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.activeOpportunities >= 12)
                return { tier: 'silver', value: s.activeOpportunities };
            if (s.activeOpportunities >= 4)
                return { tier: 'bronze', value: s.activeOpportunities };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.followUpActivities >= 50)
                return { tier: 'gold', value: s.followUpActivities };
            if (s.followUpActivities >= 25)
                return { tier: 'silver', value: s.followUpActivities };
            if (s.followUpActivities >= 10)
                return { tier: 'bronze', value: s.followUpActivities };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.consecutiveMonthsWithOrders >= 3)
                return { tier: 'gold', value: s.consecutiveMonthsWithOrders };
            if (s.consecutiveMonthsWithOrders >= 2)
                return { tier: 'silver', value: s.consecutiveMonthsWithOrders };
            if (s.consecutiveMonthsWithOrders >= 1)
                return { tier: 'bronze', value: s.consecutiveMonthsWithOrders };
            return null;
        },
    },
    // ═══ SALES (Hexagon, Gold #D97706) ═════════════════════════════════════
    {
        ...
        check: (s) => {
            if (s.ordersClosed >= 1)
                return { tier: 'bronze', value: s.ordersClosed };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.totalClosedAmount >= 10000)
                return { tier: 'bronze', value: s.totalClosedAmount };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.totalClosedAmount >= 50000)
                return { tier: 'silver', value: s.totalClosedAmount };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.totalClosedAmount >= 100000)
                return { tier: 'gold', value: s.totalClosedAmount };
            return null;
        },
    },
    {
    ...
    },
    {
        ...
        check: (s) => {
            if (s.totalClosedAmount >= 500000)
                return { tier: 'black', value: s.totalClosedAmount };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.totalClosedAmount >= 1000000)
                return { tier: 'black', value: s.totalClosedAmount };
            return null;
        },
    },
    // ═══ TERRITORY (Compass, Green #059669) ════════════════════════════════
    {
        ...
        check: (s) => {
            if (s.organizationsCreated >= 1)
                return { tier: 'bronze', value: s.organizationsCreated };
            return null;
        },
    },
    {
    ...
    },
    {
        ...
        check: (s) => {
            if (s.organizationsCreated >= 25)
                return { tier: 'silver', value: s.organizationsCreated };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.organizationsCreated >= 50)
                return { tier: 'gold', value: s.organizationsCreated };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.territoryCoveragePercent >= 100)
                return { tier: 'gold', value: s.territoryCoveragePercent };
            if (s.territoryCoveragePercent >= 50)
                return { tier: 'silver', value: s.territoryCoveragePercent };
            if (s.territoryCoveragePercent >= 25)
                return { tier: 'bronze', value: s.territoryCoveragePercent };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.territoryPenetrationPercent >= 75)
                return { tier: 'black', value: s.territoryPenetrationPercent };
            if (s.territoryPenetrationPercent >= 50)
                return { tier: 'silver', value: s.territoryPenetrationPercent };
            if (s.territoryPenetrationPercent >= 25)
                return { tier: 'bronze', value: s.territoryPenetrationPercent };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.organizationsWithThreeSports >= 50)
                return { tier: 'black', value: s.organizationsWithThreeSports };
            if (s.organizationsWithThreeSports >= 25)
                return { tier: 'silver', value: s.organizationsWithThreeSports };
            if (s.organizationsWithThreeSports >= 10)
                return { tier: 'bronze', value: s.organizationsWithThreeSports };
            return null;
        },
    },
    ...
    },
    {
        ...
        check: (s) => {
            if (s.travelGearDealClosed)
                return { tier: 'silver', value: 1 };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.teamStoreDealClosed)
                return { tier: 'gold', value: 1 };
            return null;
        },
    },
    {
    ...
    },
    {
        ...
        check: (s) => {
            ...
            if (lanes >= 4)
                return { tier: 'black', value: lanes };
            if (lanes >= 3)
                return { tier: 'gold', value: lanes };
            if (lanes >= 2)
                return { tier: 'silver', value: lanes };
            if (lanes >= 1)
                return { tier: 'bronze', value: lanes };
            return null;
        },
    },
    // ═══ LEADERSHIP (Star, Black/Gold #1E293B) ═════════════════════════════
    {
        ...
        check: (s) => {
            if (s.dealsAssisted >= 5)
                return { tier: 'silver', value: s.dealsAssisted };
            if (s.dealsAssisted >= 1)
                return { tier: 'bronze', value: s.dealsAssisted };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.isDirector && s.repsCertified >= 2)
                return { tier: 'gold', value: s.repsCertified };
            if (s.isDirector && s.repsCertified >= 1)
                return { tier: 'silver', value: s.repsCertified };
            if (s.isDirector)
                return { tier: 'bronze', value: 1 };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.territoryGrowthPercent >= 25)
                return { tier: 'gold', value: s.territoryGrowthPercent };
            if (s.territoryGrowthPercent >= 20)
                return { tier: 'silver', value: s.territoryGrowthPercent };
            if (s.territoryGrowthPercent >= 10)
                return { tier: 'bronze', value: s.territoryGrowthPercent };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.pipelineHealthPercent >= 100)
                return { tier: 'black', value: s.pipelineHealthPercent };
            if (s.pipelineHealthPercent >= 90)
                return { tier: 'gold', value: s.pipelineHealthPercent };
            if (s.pipelineHealthPercent >= 75)
                return { tier: 'silver', value: s.pipelineHealthPercent };
            if (s.pipelineHealthPercent >= 50)
                return { tier: 'bronze', value: s.pipelineHealthPercent };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.territoriesProfitable >= 2)
                return { tier: 'black', value: s.territoriesProfitable };
            if (s.territoriesProfitable >= 1)
                return { tier: 'bronze', value: s.territoriesProfitable };
            return null;
        },
    },
    // ═══ EXECUTIVE (Star, Black/Gold #D97706) ═══════════════════════════════════
    {
        ...
        check: (s) => {
            if (s.regionalDirectorsHired >= 4)
                return { tier: 'black', value: s.regionalDirectorsHired };
            if (s.regionalDirectorsHired >= 3)
                return { tier: 'gold', value: s.regionalDirectorsHired };
            if (s.regionalDirectorsHired >= 2)
                return { tier: 'silver', value: s.regionalDirectorsHired };
            if (s.regionalDirectorsHired >= 1)
                return { tier: 'bronze', value: s.regionalDirectorsHired };
            return null;
        },
    },
    {
        ...
        check: (s) => {
            if (s.statesOperational >= 4)
                return { tier: 'black', value: s.statesOperational };
            if (s.statesOperational >= 3)
                return { tier: 'gold', value: s.statesOperational };
            if (s.statesOperational >= 2)
                return { tier: 'silver', value: s.statesOperational };
            if (s.statesOperational >= 1)
                return { tier: 'bronze', value: s.statesOperational };
            return null;
        },
    },
    {
...
export function getQualificationsByCollection(collection) {
...
export function saveQualifications(store) {
    localStorage.setItem(STORAGE_KEY, JSON.stringify(store));
}
export function getEarnedQualifications() {
 ...
 */
export function seedExecutiveProfile(userId) {
...
export function getHighestEarnedTier(qualificationId) {
    const store = loadQualifications();
    ...
    return ['bronze', 'silver', 'gold', 'black'][maxOrder] ?? null;
}
// ─── Check & Award ───────────────────────────────────────────────────────────
export function checkAndAwardQualifications(stats) {
    const store = loadQualifications();
    const newlyEarned = [];
...
export function getQualificationProgress(stats) {
    const store = loadQualifications();
    ...
    return ALL_QUALIFICATIONS.map((qual) => {
        ...
        const maxOrder = earned.length > 0
            ...
            : -1;
        const earnedTier = maxOrder >= 0
            ? ['bronze', 'silver', 'gold', 'black'][maxOrder] ?? null
            : null;
...
export function getCollectionSummary(stats) {
