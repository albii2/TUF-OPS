...
export function ProgramOpportunitiesList({ opportunities }: { opportunities: OpportunityWithNumberValue[] }) {
    if (opportunities.length === 0) {
        return <p className="text-sm text-muted-foreground">No opportunities are linked to this program.</p>
    }
