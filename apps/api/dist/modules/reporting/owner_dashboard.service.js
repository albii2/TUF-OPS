...
exports.getOwnerDashboardData = getOwnerDashboardData;
...
async function getOwnerDashboardData() {
  ...
  `;
    const [nextPlays, cashBoard, pipelineFlow, opsReady, ownershipReps, ownershipDirectors] = await Promise.all([
        database_1.pool.query(nextPlaysQuery),
        database_1.pool.query(cashBoardQuery),
        database_1.pool.query(pipelineFlowQuery),
        database_1.pool.query(opsReadyQuery),
        database_1.pool.query(ownershipRepsQuery),
        database_1.pool.query(ownershipDirectorsQuery),
    ]);
    return {
...
//# sourceMappingURL=owner_dashboard.service.js.map