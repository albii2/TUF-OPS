...
describe('Reporting Service - Integration Test', () => {
    beforeAll(async () => {
        ...
        await (0, opportunities_service_1.createOpportunity)({ organization_id: org1.id, name: 'Opp 1', sport: 'football', season: 'Fall', year: 2026, value: 1000.00, assigned_rep_id: 10, assigned_director_id: 1, stage: opportunities_interface_1.OpportunityStage.LEAD_ASSIGNED, status: 'open', created_by: 1, updated_by: 1, deal_type: 'UNIFORM' });
        // Opp 2: Rep 10, Director 1, Won
        const opp2 = await (0, opportunities_service_1.createOpportunity)({ organization_id: org1.id, name: 'Opp 2', sport: 'baseball', season: 'Spring', year: 2027, value: 2500, assigned_rep_id: 10, assigned_director_id: 1, stage: opportunities_interface_1.OpportunityStage.INVOICE_SENT, status: 'open', created_by: 1, updated_by: 1, deal_type: 'UNIFORM' });
        await (0, opportunities_service_1.updateOpportunityStage)(opp2.id, opportunities_interface_1.OpportunityStage.DECISION_PENDING, 1);
        ...
        const opp3 = await (0, opportunities_service_1.createOpportunity)({ organization_id: org1.id, name: 'Opp 3', sport: 'basketball', season: 'Winter', year: 2027, value: 5000, assigned_rep_id: 20, assigned_director_id: 1, stage: opportunities_interface_1.OpportunityStage.INVOICE_SENT, status: 'open', created_by: 1, updated_by: 1, deal_type: 'UNIFORM' });
        ...
        const opp4 = await (0, opportunities_service_1.createOpportunity)({ organization_id: org2.id, name: 'Opp 4', sport: 'football', season: 'Fall', year: 2026, value: 10000, assigned_rep_id: 30, assigned_director_id: 2, stage: opportunities_interface_1.OpportunityStage.INVOICE_SENT, status: 'open', created_by: 1, updated_by: 1, deal_type: 'UNIFORM' });
        await (0, opportunities_service_1.updateOpportunityStage)(opp4.id, opportunities_interface_1.OpportunityStage.DECISION_PENDING, 1);
        ...
        await (0, opportunities_service_1.createOpportunity)({ organization_id: org2.id, name: 'Opp 5', sport: 'baseball', season: 'Spring', year: 2027, value: 20000, assigned_rep_id: 30, assigned_director_id: 2, stage: opportunities_interface_1.OpportunityStage.MOCKUP_DELIVERED, status: 'open', created_by: 1, updated_by: 1, deal_type: 'UNIFORM' });
    });
    afterAll(async () => {
    ...
    it('should return correct metrics for Owner (all records)', async () => {
        ...
        expect(metrics.opportunities_by_stage[opportunities_interface_1.OpportunityStage.LEAD_ASSIGNED]).toBe(9);
        expect(metrics.opportunities_by_stage[opportunities_interface_1.OpportunityStage.CLOSED_WON]).toBe(2);
        expect(metrics.opportunities_by_stage[opportunities_interface_1.OpportunityStage.CLOSED_LOST]).toBe(1);
        expect(metrics.opportunities_by_stage[opportunities_interface_1.OpportunityStage.MOCKUP_DELIVERED]).toBe(1);
        expect(metrics.opportunities_by_stage[opportunities_interface_1.OpportunityStage.CONTACTED]).toBe(0);
    });
