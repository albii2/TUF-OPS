exports.up = (pgm) => {
  ...
  pgm.sql(`
    WITH incoming(title, description, role, phase, order_index, content_markdown, estimated_duration_minutes, module_type) AS (
      VALUES
      ('Welcome to TUF Sports Apparel', 'TUF exists to help schools, clubs, and teams buy apparel with speed, trust, and clear follow-through. Reps sell outcomes: sharper unifo', 'TAE', 'LEVEL_1_OPERATOR', 1, '## Training Explanation
...
', 35, 'MODULE'),
      ('How TUF Makes Money', 'TUF earns through uniforms, player packs, team stores, travel gear, letterman campaigns, and repeat school relationships. Margin comes ', 'TAE', 'LEVEL_1_OPERATOR', 2, '## Training Explanation
...
', 35, 'MODULE'),
      ('Rep Expectations: 4 Orders Per Month', 'The launch standard is four completed orders per month. That requires daily touches, clean follow-up, accurate CRM notes, and enough pi', 'TAE', 'LEVEL_1_OPERATOR', 3, '## Training Explanation
...
', 35, 'MODULE'),
      ('72-Hour Certification Standard', 'Reps have a 72-hour window to complete Academy modules, prove practical selling ability, and earn director sign-off before full CRM acc', 'TAE', 'LEVEL_1_OPERATOR', 4, '## Training Explanation
...
', 35, 'MODULE'),
      ('How Certification Unlocks CRM Access', 'Academy is open first. Full CRM access remains gated until required modules, HR documents, practical exercise, and director sign-off ar', 'TAE', 'LEVEL_1_OPERATOR', 5, '## Training Explanation
...
', 35, 'MODULE'),
      ('Uniforms: TUF SHIFT, TUF GRIND, TUF OVERTIME, TUF FLEX', 'Uniform selling starts with sport, roster size, season date, current vendor pain, design expectations, and reorder needs. SHIFT, GRIND,', 'TAE', 'LEVEL_2_PRODUCT', 1, '## Training Explanation
...
', 35, 'MODULE'),
      ('Player Packs and Travel Gear', 'Player packs and travel gear turn a uniform sale into a complete team package. Coaches want simplicity, consistent appearance, and fewe', 'TAE', 'LEVEL_2_PRODUCT', 2, '## Training Explanation
...
', 35, 'MODULE'),
      ('Team Stores', 'Team stores create fan revenue, parent convenience, and repeatable seasonal ordering. They work for schools, boosters, youth clubs, and', 'TAE', 'LEVEL_2_PRODUCT', 3, '## Training Explanation
...
', 35, 'MODULE'),
      ('Letterman Jackets', 'Letterman jackets are annual recognition campaigns. The buyer may be AD, activities office, booster, or parents. Timing and school trad', 'TAE', 'LEVEL_2_PRODUCT', 4, '## Training Explanation
...
', 35, 'MODULE'),
      ('Price Confidence and Margin Basics', 'Price confidence protects the business. Reps must know that discounting without reason trains buyers to ignore value. Margin funds serv', 'TAE', 'LEVEL_2_PRODUCT', 5, '## Training Explanation
...
', 35, 'MODULE'),
      ('Understanding Assigned Schools', 'Assigned schools are your book. Assignment alone is not a touch. A school is touched only when there is a logged call, email, text, mee', 'TAE', 'LEVEL_3_TERRITORY', 1, '## Training Explanation
...
', 35, 'MODULE'),
      ('How to Work Athletic Directors and Coaches', 'ADs control standards and relationships; coaches control pain, urgency, and team needs. Work both respectfully.', 'TAE', 'LEVEL_3_TERRITORY', 2, '## Training Explanation
...
', 35, 'MODULE'),
      ('Feeder Programs and Youth Extraction', 'Feeder programs create volume and future school relationships. Youth and club directors often need stores, packs, and simplified orderi', 'TAE', 'LEVEL_3_TERRITORY', 3, '## Training Explanation
...
', 35, 'MODULE'),
      ('Travel Teams and Club Opportunities', 'Travel and club teams buy more frequently, move faster, and need identity. They can become team store and pack accounts quickly.', 'TAE', 'LEVEL_3_TERRITORY', 4, '## Training Explanation
...
', 35, 'MODULE'),
      ('How to Log a School Touch Correctly', 'If it is not logged, it did not happen. Touches must be auditable and tied to the account or opportunity.', 'TAE', 'LEVEL_3_TERRITORY', 5, '## Training Explanation
...
', 35, 'MODULE'),
      ('Discovery Call Framework', 'Discovery finds pain, timing, authority, budget range, sport needs, and next step. It is not a product monologue.', 'TAE', 'LEVEL_4_SALES', 1, '## Training Explanation
...
', 35, 'MODULE'),
      ('First Contact Script', 'First contact must be short, relevant, and specific. The goal is not to close; it is to earn the next conversation.', 'TAE', 'LEVEL_4_SALES', 2, '## Training Explanation
...
', 35, 'MODULE'),
      ('Handling “We Already Have a Vendor”', 'A current vendor is normal. Do not attack them. Find the gap: speed, design, communication, price clarity, store execution, or expansio', 'TAE', 'LEVEL_4_SALES', 3, '## Training Explanation
...
', 35, 'MODULE'),
      ('Getting to Mockup/Sample', 'Mockups and samples turn interest into visible progress. They must be tied to a real team, real season, and decision path.', 'TAE', 'LEVEL_4_SALES', 4, '## Training Explanation
...
', 35, 'MODULE'),
      ('Follow-Up Discipline', 'Follow-up is where most reps lose deals. Every opportunity needs a next action, date, and reason.', 'TAE', 'LEVEL_4_SALES', 5, '## Training Explanation
...
', 35, 'MODULE'),
      ('Moving from Interest to Closed Won', 'Closed Won requires decision, scope, price, timeline, and handoff clarity. Do not mark a deal won because someone sounded interested.', 'TAE', 'LEVEL_4_SALES', 6, '## Training Explanation
...
', 35, 'MODULE'),
      ('Dashboard Basics', 'Dashboard metrics show what needs action: assigned schools, touched/untouched accounts, active opportunities, follow-ups, paid orders, ', 'TAE', 'LEVEL_5_EXPANSION', 1, '## Training Explanation
...
', 35, 'MODULE'),
      ('Organizations and Contacts', 'Organizations hold schools, clubs, and account data. Contacts hold the people who move decisions.', 'TAE', 'LEVEL_5_EXPANSION', 2, '## Training Explanation
...
', 35, 'MODULE'),
      ('Opportunities and Stages', 'Opportunities track real commercial movement. Stage changes must reflect buyer progress, not rep optimism.', 'TAE', 'LEVEL_5_EXPANSION', 3, '## Training Explanation
...
', 35, 'MODULE'),
      ('Orders After Closed Won', 'Closed Won should create an order handoff with assigned rep/director visibility. Orders are where production and payment reality begin.', 'TAE', 'LEVEL_5_EXPANSION', 4, '## Training Explanation
...
', 35, 'MODULE'),
      ('Commission Basics and Payment-Gated Earnings', 'Commissions are server-side and payment/fulfillment gated. Reps should care about clean order completion, not just verbal wins.', 'TAE', 'LEVEL_5_EXPANSION', 5, '## Training Explanation
...
', 35, 'MODULE'),
      ('Football', 'Football selling requires specific buyer timing, language, objections, and expansion paths. Reps must adapt the TUF pitch to the sport ', 'TAE', 'SPECIALIZED_TRACKS', 1, '## Training Explanation
...
', 25, 'HANDS_ON'),
      ('Basketball', 'Basketball selling requires specific buyer timing, language, objections, and expansion paths. Reps must adapt the TUF pitch to the spor', 'TAE', 'SPECIALIZED_TRACKS', 2, '## Training Explanation
...
Study the sport calendar, roster count, parent involvement, and likely add-on lanes. Ask for the next season trigger and a mockup/sample step.
', 25, 'HANDS_ON'),
      ('Baseball', 'Baseball selling requires specific buyer timing, language, objections, and expansion paths. Reps must adapt the TUF pitch to the sport ', 'TAE', 'SPECIALIZED_TRACKS', 3, '## Training Explanation
...
Study the sport calendar, roster count, parent involvement, and likely add-on lanes. Ask for the next season trigger and a mockup/sample step.
', 25, 'HANDS_ON'),
      ('Volleyball', 'Volleyball selling requires specific buyer timing, language, objections, and expansion paths. Reps must adapt the TUF pitch to the spor', 'TAE', 'SPECIALIZED_TRACKS', 4, '## Training Explanation
...
Study the sport calendar, roster count, parent involvement, and likely add-on lanes. Ask for the next season trigger and a mockup/sample step.
', 25, 'HANDS_ON'),
      ('Women’s Sports', 'Women’s Sports selling requires specific buyer timing, language, objections, and expansion paths. Reps must adapt the TUF pitch to the ', 'TAE', 'SPECIALIZED_TRACKS', 5, '## Training Explanation
...
Study the sport calendar, roster count, parent involvement, and likely add-on lanes. Ask for the next season trigger and a mockup/sample step.
', 25, 'HANDS_ON'),
      ('7v7/Flag', '7v7/Flag selling requires specific buyer timing, language, objections, and expansion paths. Reps must adapt the TUF pitch to the sport ', 'TAE', 'SPECIALIZED_TRACKS', 6, '## Training Explanation
...
Study the sport calendar, roster count, parent involvement, and likely add-on lanes. Ask for the next season trigger and a mockup/sample step.
', 25, 'HANDS_ON'),
      ('Youth Programs', 'Youth Programs selling requires specific buyer timing, language, objections, and expansion paths. Reps must adapt the TUF pitch to the ', 'TAE', 'SPECIALIZED_TRACKS', 7, '## Training Explanation
...
Study the sport calendar, roster count, parent involvement, and likely add-on lanes. Ask for the next season trigger and a mockup/sample step.
', 25, 'HANDS_ON'),
      ('Letterman Jacket Campaigns', 'Letterman Jacket Campaigns selling requires specific buyer timing, language, objections, and expansion paths. Reps must adapt the TUF p', 'TAE', 'SPECIALIZED_TRACKS', 8, '## Training Explanation
...
Study the sport calendar, roster count, parent involvement, and likely add-on lanes. Ask for the next season trigger and a mockup/sample step.
', 25, 'HANDS_ON'),
      ('Director Certification Review', 'Directors certify reps by verifying modules, HR docs, practical simulator exercise, and readiness for live CRM access.', 'TAE', 'LEVEL_7_DIRECTOR', 1, '## Training Explanation
...
', 35, 'MODULE'),
      ('Minnesota Launch Market Mastery', 'Minnesota launch reps must understand school seasonality, football/basketball/baseball opportunities, hockey pockets, youth feeders, an', 'TAE', 'MARKET_MASTERY', 1, '## Training Explanation
