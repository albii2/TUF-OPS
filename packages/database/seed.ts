...
const STAGES = ['NOT_STARTED', 'LEAD_ASSIGNED', 'CONTACT_INITIATED', 'MOCKUP_IN_PROGRESS', 'MOCKUP_APPROVED', 'SAMPLE_REQUESTED', 'SAMPLE_IN_PRODUCTION', 'SAMPLE_APPROVED', 'INVOICE_SENT', 'PAYMENT_RECEIVED', 'CLOSED_WON', 'CLOSED_LOST'];
