...
export type SidebarKey = 'dashboard' | 'pipeline' | 'organizations' | 'ecosystem' | 'programs' | 'territory' | 'invoices' | 'performance' | 'messages' | 'ops_workspace' | 'settings' | 'users' | 'academy' | 'certification_review' | 'documents' | 'daily_command' | 'recruiting';
