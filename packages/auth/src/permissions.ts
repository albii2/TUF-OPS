import { normalizeRole, roles, type Role } from './roles.js';
...
const DIRECTOR_PERMISSIONS = [
  ...
  permissions.VIEW_CERT_PROGRESS_TEAM, permissions.VIEW_RELATIONSHIP_HISTORY, permissions.LOG_RELATIONSHIP_ACTIVITY,
  permissions.VIEW_RENEWAL_PIPELINE, permissions.INVITE_USER, permissions.DEACTIVATE_USER, permissions.CONFIGURE_TERRITORY,
